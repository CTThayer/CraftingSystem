...
#region Motion List
    ...
    private bool DrawMotionDetailItem(int rMotionIndex, MotionControllerMotion rMotion)
    {
        ...
        {
            //if (!ReflectionHelper.IsTypeValid("com.ootii.Input.EasyInput, " + AssemblyHelper.Instance.AssemblyInfo))
            //{
            //    EditorGUILayout.BeginVertical(EditorHelper.Box);
...
#region Support Functions
    ...
    private void EnableMMOStyle()
    {
        ...
        // CDL 07/03/2018 - obtain the assembly name from AssemblyHelper.Instance.AssemblyInfo
        // Get or create the input source        
        IInputSource lInputSource = CreateInputSource("com.ootii.Input.EasyInputSource, " + AssemblyHelper.Instance.AssemblyInfo);
        ...
        //bool lIsAdventureRigAvailable = ReflectionHelper.IsTypeValid("com.ootii.Cameras.CameraController, " + AssemblyHelper.Instance.AssemblyInfo);

        // CDL 07/03/2018 - obtain the assembly name from AssemblyHelper.Instance.AssemblyInfo
        BaseCameraRig lCameraRig = CreateCameraRig("com.ootii.Cameras.CameraController, " + AssemblyHelper.Instance.AssemblyInfo);
        if (lCameraRig == null) { lCameraRig = CreateCameraRig("com.ootii.Cameras.OrbitRig, " + AssemblyHelper.Instance.AssemblyInfo); }
    ...
    private void EnableShooterStyle()
    {
        ...
        // Get or create the camera
        BaseCameraRig lCameraRig = CreateCameraRig("com.ootii.Cameras.CameraController, " + AssemblyHelper.Instance.AssemblyInfo);
        if (lCameraRig == null) { lCameraRig = CreateCameraRig("com.ootii.Cameras.FollowRig, " + AssemblyHelper.Instance.AssemblyInfo); }
        if (lCameraRig == null) { return; }
