    ...
    public class LayerDefinitionSetEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            try
            {
                ...
                string lLayersInUse;
                if (mOverwriteExistingLayers.boolValue && LayersSetupHelper.AreDefaultLayersInUse(out lLayersInUse))
                {
                    EditorHelper.DrawInspectorDescription("The following layers are already defined and will be overwritten:\n\n" +
                                                          lLayersInUse, MessageType.Warning);
                }
