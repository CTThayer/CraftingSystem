...
namespace com.ootii.MotionControllerPacks
{
    ...
    public class Damaged : MotionControllerMotion
    {
        ...
        public override bool TestUpdate()
        {
            ...
            if (!mMotionController.IsGrounded) { return false; }
            //if (mMotionController.Stance != EnumControllerStance.COMBAT_MELEE_SWORD_SHIELD) { return false; }
        ...
        public override void OnMessageReceived(IMessage rMessage)
        {
            ...
            if (mMotionController.Stance != EnumControllerStance.TRAVERSAL) { return; }
