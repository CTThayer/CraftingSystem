...
namespace com.ootii.Actors.AnimationControllers
{
    ...
    public class ClimbCrouch : MotionControllerMotion
    {
        ...
        public override bool Activate(MotionControllerMotion rPrevMotion)
        {
            ...
            // Set the state
            mStoredStance = mMotionController.Stance;
            mMotionController.Stance = EnumControllerStance.CLIMB_CROUCH;
        ...
        public override void Deactivate()
        {
            ...
            // Clear the stance
            if (mMotionController.Stance == EnumControllerStance.CLIMB_CROUCH)
            {
                mMotionController.Stance = mStoredStance;
            }
        ...
        /// </summary>
        /// <param name="rOffset">Side distance to check. Left is negative and right is positive.</param>
