...
namespace com.ootii.Actors.AnimationControllers
{
    ...
    public class Sleep : MotionControllerMotion
    {
        ...
        public override bool Activate(MotionControllerMotion rPrevMotion)
        {
            ...
            mMotionController.Stance = EnumControllerStance.UNCONSCIOUS;
        ...
        /// <summary>
        /// Called to stop the motion. If the motion is stoppable. Some motions
        ...
        public override void OnMessageReceived(IMessage rMessage)
        {
            ...
            if (mMotionController.Stance != EnumControllerStance.UNCONSCIOUS) { return; }
