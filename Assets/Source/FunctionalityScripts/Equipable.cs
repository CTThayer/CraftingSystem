...
public enum EquipmentType
{
    ...
    // For the purposes of matching tutorial... (use above for final version)
    Accessory1,
    Accessory2,
    Weapon1,
    Weapon2,
...
public class Equipable : Storable, IActionable
{
    ...
    public void Equip(Character c)
    {
        ...
        // 2.   Re-enable the disabled components of the item (i.e. collider,
        //      mesh, renderer, etc.)
    ...
    public void Unequip(Character c)
    {
        ...
        //   c. Update the skeleton to reflect the unequipped item (i.e. open
        //      the character's hand if it was previously closed around an item)
        // 2.   Disable the components of the item (i.e. colliders, mesh, etc.)
