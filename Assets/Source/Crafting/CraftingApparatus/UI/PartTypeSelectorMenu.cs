...
public class PartTypeSelectorMenu : MonoBehaviour
{
    ...
    //        dropdown.AddOptions(designList);
    //    }
    //    else
    //    {
    ...
    //    Debug.Assert(confirmButton != null);
    ...
    //public void SetConfirmButtonDelegate(PartDesignerUIController uiController)
    //{
    //    confirmButton.onClick.AddListener(uiController.OnLaunchMenuConfirm);
    //}

    //public void SetBackButtonDelegate(PartDesignerUIController uiController)
    //{
    //    confirmButton.onClick.AddListener(uiController.OnLaunchMenuBack);
    //}
